...
export default class SiteMap extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(router.route('contents.pages-tree'))
            .then(response => {
                var items = [];
            ...
            <div className="dashboard-graph">
                ...
                <div className="dashboard-body">
                    <div className="col-xs-3 sidebar">
                        ...
                        &nbsp;<a href={"/backender/contents/" + this.state.selectedInfo.id} target="_blank"><i className="fa fa-pencil-alt"></i> {Lang.get('home.edit')}</a>
                                    </li>
                                </ul>
                            </div>
                        }
